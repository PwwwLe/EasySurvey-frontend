...
import { ElCard, ElRow, ElCol, ElButton, ElInput, ElSelect, ElOption } from 'element-plus';
...
<template>
    <!-- 返回按钮 -->
    <el-button type="primary" @click="() => router.push('/index/basicInfo')" class="back-button">返回</el-button>
    ...
    <el-card class="edit-info-card">
        ...
        <el-row class="edit-info-row">
            ...
            <el-col :span="16">
                <el-input v-model="editData.avatar" placeholder="请输入头像URL"></el-input>
            </el-col>
        </el-row>
        <el-row class="edit-info-row">
            <el-col :span="8">企业名:</el-col>
            <el-col :span="16">
                <el-input v-model="editData.name" placeholder="请输入企业名"></el-input>
            </el-col>
        </el-row>
        <el-row class="edit-info-row">
